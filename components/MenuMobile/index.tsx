      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            animate={{ x: '0' }}
            exit={{ x: '100%' }}
            className="py-[22px] px-1.5 rounded-tl-[10px] rounded-bl-[10px] bg-[rgba(74,176,234,0.50)] bg-opacity-50 backdrop-blur-[10px] fixed bottom-0 right-0 w-[416px] max-xs:w-[95%] flex flex-col gap-3 z-[9000] h-[100vh]"
          >
