    ...
    >
      ...
      <div className="flex items-center justify-center container w-full h-full">
        <div className="flex items-start max-lg:items-center max-lg:mt-60 max-lg:justify-start w-full max-w-[90%] flex-col gap-5 justify-center h-full relative">
          <div
            className={`__className_02ffdd [font-feature-settings:_'liga'_off,_'clig'_off]  [-webkit-text-stroke-color:_#000] text-[64px] max-lg:text-[42px] leading-none text-white tracking-[-5px] max-lg:tracking-[-1px] z-[2] lg:[text-shadow:_0px_6px_0px_#000] lg:[-webkit-text-stroke-width:_6.07px] [text-shadow:_0px_4px_0px_#000] [-webkit-text-stroke-width:_4.07px]`}
          >
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[500px] max-xs:w-[60%] max-lg:w-[300px] h-[700px] max-lg:h-[600px]">
            <Image
              src={'/static/images/store/main-section/duck.png'}
              alt="Duck"
              width={168}
              height={117}
            ...
            ></Image>
            <Image
              src={'/static/images/store/main-section/astronaut.png'}
              alt="Astronaut"
              width={168}
              height={117}
            ...
            ></Image>
            <Image
              src={'/static/images/store/main-section/pipe.png'}
              alt="Pipe"
              width={243}
              height={233}
