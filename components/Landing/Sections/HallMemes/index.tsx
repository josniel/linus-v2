...
import { MEMES } from '@/components/Landing/Sections/Data';
      ...
      <div className="h-[1100px] max-xl:h-[900px] max-lg:h-[720px] max-xs:h-[430px] container flex items-center flex-col gap-7 py-16 max-xs:pt-10">
        ...
        <div className="w-[1400px] absolute bottom-0 left-1/2 -translate-x-1/2 z-[2] max-lg:z-[0] max-xs:hidden">
          <Image
            ...
            height={1051}
            quality={100}
            className="absolute bottom-0 left-0 max-2xl:w-[690px] max-xl:w-[550px] max-2xl:left-20 max-xl:left-44 max-lg:left-auto max-lg:right-36 max-md:right-56 max-lg:scale-x-[-1]"
          ></Image>
        </div>
        <Image
          ...
          height={339}
          quality={100}
          className="absolute bottom-0 -right-16 xs:hidden"
        />
          ...
          {memes.map((meme, index) => {
            return (
              ...
              >
                ...
                ></Image>
                <div className="backdrop-blur-md absolute bottom-0 w-full flex flex-col gap-2 px-10 py-5">
