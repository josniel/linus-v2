  ...
  return (
    <div className="h-[600px] relative flex flex-col items-center justify-center">
      ...
      >
        ...
        <div
          className={`absolute rotate-90 left-0 top-1/2 -translate-y-1/2 transition-opacity text-2xl text-shark-400 bg-shark-50 w-11 h-11 rounded-full flex items-center justify-center cursor-pointer z-20 ${sliderScrollState === 'start' ? 'opacity-0' : 'opacity-100'} max-lg:hidden`}
          onClick={() => {
        ...
        <div
          className={`absolute -rotate-90 right-0 top-1/2 -translate-y-1/2 transition-opacity text-2xl text-shark-400 bg-shark-50 w-11 h-11 rounded-full flex items-center justify-center cursor-pointer z-20 ${sliderScrollState === 'end' ? 'opacity-0' : 'opacity-100'} max-lg:hidden`}
          onClick={() => {
