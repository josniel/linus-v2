...
export const PENGMILIOS3 = [
  ...
  },
  {
    ...
    backgroundColor:
      '[background:_linear-gradient(180deg,_#171D37_0%,_#3D498F_50%,_#6370D7_100%)]',
    textColor: 'text-[#FFFFFF]',
  },
  {
...
export const PENGMILIOS_MOBILE = [
  ...PENGMILIOS1,
  ...PENGMILIOS2,
  ...PENGMILIOS3,
  ...PENGMILIOS4,
...
export const MEMES = [
  {
    image: '/static/images/landing/memes/meme5.png',
    title: 'Pengmilio in the Wild',
    description:
      'The Pengmilio Hall of Memes is a place where the community can share their funniest, most creative, and most entertaining memes. Pengmilio is a fun character, and we want to see your best memes about him!',
  },
  {
    image: '/static/images/landing/memes/meme4.png',
    title: 'Pengmilio in the Wild',
    description:
      'The Pengmilio Hall of Memes is a place where the community can share their funniest, most creative, and most entertaining memes. Pengmilio is a fun character, and we want to see your best memes about him!',
  },
  {
    image: '/static/images/landing/memes/meme3.png',
    title: 'Pengmilio in the Wild',
    description:
      'The Pengmilio Hall of Memes is a place where the community can share their funniest, most creative, and most entertaining memes. Pengmilio is a fun character, and we want to see your best memes about him!',
  },
  {
    image: '/static/images/landing/memes/meme2.png',
    title: 'Pengmilio in the Wild',
    description:
      'The Pengmilio Hall of Memes is a place where the community can share their funniest, most creative, and most entertaining memes. Pengmilio is a fun character, and we want to see your best memes about him!',
  },
  {
    image: '/static/images/landing/memes/meme1.png',
    title: 'Pengmilio in the Wild',
    description:
      'The Pengmilio Hall of Memes is a place where the community can share their funniest, most creative, and most entertaining memes. Pengmilio is a fun character, and we want to see your best memes about him!',
  },
...
export const BRIDGES = [
  {
    logo: '/static/images/landing/bridge/linea.svg',
    url: 'https://bridge.linea.build/',
  },
  {
    logo: '/static/images/landing/bridge/debridge.svg',
