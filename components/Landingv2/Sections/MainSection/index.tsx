    ...
    >
      ...
      <div className="flex items-center flex-col gap-3 w-full relative z-[1] mt-[100px] max-md:mt-[120px] container">
        <Image
          ...
          width={3028}
          height={1388}
          className="w-[500px] max-lg:max-w-[85%] max-sm:hidden"
          priority={true}
        ></Image>
        <Image
          src={'/static/images/landing/main-section/linus-on-linea-mobile.png'}
          alt="Linus on Linea"
          width={282}
          height={128}
          className="sm:hidden max-xxs:max-w-[95%]"
          priority={true}
        ></Image>
      ...
      <div className="absolute -bottom-6 left-1/2 -translate-x-1/2 !w-[490px] md:hidden">
        <Image
          src={'/static/images/landing/main-section/eggs-mobile.webp'}
          alt="Eggs"
          width={490}
          height={282}
          quality={100}
