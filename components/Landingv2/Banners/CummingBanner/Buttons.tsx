const Buttons = () => {
  return (
    <div className="flex absolute items-center gap-[5px] lg:gap-3.5 xl2:gap-5 right-3 lg:bottom-3 uppercase bebas-neue-regular text-white text-[14px] lg:text-[17.5px] xl2:text-[25px] max-lg:bottom-[22px] z-10">
          <a
            href="https://element.market/linea/launchpad/linus-eggs"
            target="_blank"
            className="whitespace-nowrap uppercase border-[#409BDD] border-[3px] xl2:border-[5px] rounded-[30px] bg-[rgba(64,155,221,0.30)] hover:bg-[#409BDD] transition-colors backdrop-blur-[10px] px-[7px] max-lg:pr-[17px] lg:px-[15px] py-[14px] max-lg:py-[7px] flex gap-[5px] items-center"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            className="border-[#409BDD] border-[3px] xl2:border-[5px] rounded-[30px] bg-[rgba(64,155,221,0.30)] hover:bg-[#409BDD] transition-colors backdrop-blur-[10px] px-[7px] lg:px-[15px] py-[14px] max-lg:py-[7px] flex gap-[5px] items-center"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
